...
#f8824: {
	#input: {
		...
		chkWasRelPartyInd: *"" |
			"1" | // Line 7. Was the exchange of the property given up or received made with a related party, either directly or indirectly (such as through an intermediary)? See instructions. If �Yes, � complete Part II. If �No, � go to Part III
		...
		chkDurYrRelPartySellInd: *"" |
			"1" | // Line 9. During this tax year (and before the date that is 2 years after the last transfer of property that was part of  the exchange), did the related party sell or dispose of any part of the like-kind property received from you (or an intermediary) in the exchange?
		...
		chkDurYrTaxpayerSellInd: *"" |
			"1" | // Line 10. During this tax year (and before the date that is 2 years after the last transfer of property that was part of  the exchange), did you sell or dispose of any part of the like-kind property you received?
		...
		chkDisposInd: *"" |
			"1" | // Line 11a. The disposition was after the death of either of the related parties
