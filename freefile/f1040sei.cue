...
#f1040sei: {
	#input: {
		...
		// yes Go to line 5 - Was the child under age 24 at the end of 2021, a student, and younger than you (or your spouse, if filing jointly)?
		// no Go to line 4b Was the child under age 24 at the end of 2021, a student, and younger than you (or your spouse, if filing jointly)?
		chkUnderAge24Child1: "Y" | "N"

		
		// yes Go to line 5 - Was the child under age 24 at the end of 2021, a student, and younger than you (or your spouse, if filing jointly)?
		// no Go to line 4b - Was the child under age 24 at the end of 2021, a student, and younger than you (or your spouse, if filing jointly)?
		chkUnderAge24Child2: "Y" | "N"

		
		// yes Go to line 5 - Was the child under age 24 at the end of 2021, a student, and younger than you (or your spouse, if filing jointly)?
		// no Go to line 4b - Was the child under age 24 at the end of 2021, a student, and younger than you (or your spouse, if filing jointly)?
		chkUnderAge24Child3: "Y" | "N"

		
		// Yes Go to line 5 - Was the child permanently and totally disabled during any part of 2021?
		// No The child is not a qualifying child - Line 4b. Was the child permanently and totally disabled during any part of 2021?
		chkDisabledChild1: "Y" | "N"

		
		// Yes Go to line 5 - Was the child permanently and totally disabled during any part of 2021?
		// No The child is not a qualifying child - Line 4b. Was the child permanently and totally disabled during any part of 2021?
		chkDisabledChild2: "Y" | "N"
