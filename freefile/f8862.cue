...
#f8862: {
	#input: {
		...
		// Line-3. If the only reason your EIC was reduced or disallowed was because you incorrectly reported your earned  income or investment income, check �Yes. � Otherwise, check �No. �
		// Line-3. If the only reason your EIC was reduced or disallowed was because you incorrectly reported your earned income or investment income, check �Yes. � Otherwise, check �No. �
		chkF8862EicDisallowInd: "1" | "0"

		
		// Line-4. Could you (or your spouse if filing jointly) be claimed as a qualifying child of another taxpayer for the year entered on line 1?
		// Line-4. Could you (or your spouse if filing jointly) be claimed as a qualifying child of another taxpayer for the year entered on line 1?
		chkF8862QualDepOthPer: "1" | "0"
		...
		// Line-6. Does your completed Schedule EIC for the year entered on line 1 show that you had a qualifying child for the EIC?
		// Line-6. Does your completed Schedule EIC for the year entered on line 1 show that you had a qualifying child for the EIC?
		chkf8862QualChildEicInd: "1" | "0"
		...
		// Line-11a. Can you be claimed as a dependent on another taxpayer�s return?
		// Line-11a. Can you be claimed as a dependent on another taxpayer�s return?
		chkF8862PriClmDepAnoRtn: "1" | "0"

		
		// Line-11b. Can your spouse (if filing jointly) be claimed as a dependent on another taxpayer�s return?
		// Line-11b. Can your spouse (if filing jointly) be claimed as a dependent on another taxpayer�s return?
		chkF8862SpoClmDepAnoRtn: "1" | "0"
		...
		// Line-14. For each child listed in response to question 12, did the child live with you for more than half of the year or meet an exception described in the instructions?
		// Line-14. For each child listed in response to question 12, did the child live with you for more than half of the year or meet an exception described in the instructions?
		chkF8862Child1LivemoreHfyr: "1" | "0"

		
		// Line-14. For each child listed in response to question 12, did the child live with you for more than half of the year or meet an exception described in the instructions?
		// Line-14. For each child listed in response to question 12, did the child live with you for more than half of the year or meet an exception described in the instructions?
		chkF8862Child2LivemoreHfyr: "1" | "0"

		
		// Line-14. For each child listed in response to question 12, did the child live with you for more than half of the year or meet an exception described in the instructions?
		// Line-14. For each child listed in response to question 12, did the child live with you for more than half of the year or meet an exception described in the instructions?
		chkF8862Child3LivemoreHfyr: "1" | "0"

		
		// Line-14. For each child listed in response to question 12, did the child live with you for more than half of the year or meet an exception described in the instructions?
		// Line-14. For each child listed in response to question 12, did the child live with you for more than half of the year or meet an exception described in the instructions?
		chkF8862Child4LivemoreHfyr: "1" | "0"

		
		// Line-15. For each child listed in response to question 12, did the child meet the requirements to be a qualifying child for the CTC/RCTC/ACTC?
		// Line-15. For each child listed in response to question 12, did the child meet the requirements to be a qualifying child for the CTC/RCTC/ACTC?
		chkF8862ReqQualChild1Clm: "1" | "0"

		
		// Line-15. For each child listed in response to question 12, did the child meet the requirements to be a qualifying child for the CTC/RCTC/ACTC?
		// Line-15. For each child listed in response to question 12, did the child meet the requirements to be a qualifying child for the CTC/RCTC/ACTC?
		chkF8862ReqQualChild2Clm: "1" | "0"

		
		// Line-15. For each child listed in response to question 12, did the child meet the requirements to be a qualifying child for the CTC/RCTC/ACTC?
		// Line-15. For each child listed in response to question 12, did the child meet the requirements to be a qualifying child for the CTC/RCTC/ACTC?
		chkF8862ReqQualChild3Clm: "1" | "0"

		
		// Line-15. For each child listed in response to question 12, did the child meet the requirements to be a qualifying child for the CTC/RCTC/ACTC?
		// Line-15. For each child listed in response to question 12, did the child meet the requirements to be a qualifying child for the CTC/RCTC/ACTC?
		chkF8862ReqQualChild4Clm: "1" | "0"

		
		// Line-16. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person your dependent? - Child 1
		// Line-16. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person your dependent? - Child 1
		chkF8862CTCChild1asDep: "1" | "0"

		
		// Line-16. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person your dependent? - Child 2
		// Line-16. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person your dependent? - Child 2
		chkF8862CTCChild2asDep: "1" | "0"

		
		// Line-16. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person your dependent? - Child 3
		// Line-16. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person your dependent? - Child 3
		chkF8862CTCChild3asDep: "1" | "0"

		
		// Line-16. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person your dependent? - Child 4
		// Line-16. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person your dependent? - Child 4
		chkF8862CTCChild4asDep: "1" | "0"

		
		// Line-16. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person your dependent? -  Other Dependent 2
		// Line-16. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person your dependent? -  Other Dependent 2
		chkF8862ODCChildasDep2: "1" | "0"

		
		// Line-16. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person your dependent? -  Other Dependent 1
		// Line-16. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person your dependent? -  Other Dependent 1
		chkF8862ODCChildasDep1: "1" | "0"

		
		// Line-16. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person your dependent? -  Other Dependent 4
		// Line-16. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person your dependent? -  Other Dependent 4
		chkF8862ODCChildasDep4: "1" | "0"

		
		// Line-16. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person your dependent? -  Other Dependent 3
		// Line-16. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person your dependent? -  Other Dependent 3
		chkF8862ODCChildasDep3: "1" | "0"

		
		// Line-17. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person a citizen, national, or resident of the United States? - Child 1
		// Line-17. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person a citizen, national, or resident of the United States? - Child 1
		chkF8862CTCUScitiDep1: "1" | "0"

		
		// Line-17. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person a citizen, national, or resident of the United States? - Child 2
		// Line-17. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person a citizen, national, or resident of the United States? - Child 2
		chkF8862CTCUScitiDep2: "1" | "0"

		
		// Line-17. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person a citizen, national, or resident of the United States? -  Child 3
		// Line-17. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person a citizen, national, or resident of the United States? - Child 3
		chkF8862CTCUScitiDep3: "1" | "0"

		
		// Line-17. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person a citizen, national, or resident of the United States? - Child 4
		// Line-17. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person a citizen, national, or resident of the United States? - Child 4
		chkF8862CTCUScitiDep4: "1" | "0"

		
		// Line-17. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person a citizen, national, or resident of the United States? - Other Dependent 1
		// Line-17. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person a citizen, national, or resident of the United States? - Other Dependent 1
		chkF8862ODCUScitiDep1: "1" | "0"

		
		// Line-17. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person a citizen, national, or resident of the United States? - Other Dependent 2
		// Line-17. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person a citizen, national, or resident of the United States? - Other Dependent 2
		chkF8862ODCUScitiDep2: "1" | "0"

		
		// Line-17. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person a citizen, national, or resident of the United States? - Other Dependent 3
		// Line-17. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person a citizen, national, or resident of the United States? - Other Dependent 3
		chkF8862ODCUScitiDep3: "1" | "0"

		
		// Line-17. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person a citizen, national, or resident of the United States? - Other Dependent 4
		// Line-17. For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person a citizen, national, or resident of the United States? - Other Dependent 4
		chkF8862ODCUScitiDep4: "1" | "0"
		...
		// Line-19a. Did the student meet the requirements to be an eligible student for purposes of the AOTC for the year entered on line 1? - Student 1
		// Line-19a. Did the student meet the requirements to be an eligible student for purposes of the AOTC for the year entered on line 1? - Student 1
		chkF8862StuReqEliAOTC1: "1" | "0"

		
		// Line-19a. Did the student meet the requirements to be an eligible student for purposes of the AOTC for the year entered on line 1? - Student 2
		// Line-19a. Did the student meet the requirements to be an eligible student for purposes of the AOTC for the year entered on line 1? - Student 2
		chkF8862StuReqEliAOTC2: "1" | "0"

		
		// Line-19a. Did the student meet the requirements to be an eligible student for purposes of the AOTC for the year entered on line 1? - Student 3
		// Line-19a. Did the student meet the requirements to be an eligible student for purposes of the AOTC for the year entered on line 1? - Student 3
		chkF8862StuReqEliAOTC3: "1" | "0"

		
		// Line-19b. Has the Hope Scholarship Credit or AOTC been claimed for the student for any 4 tax years before the year entered on line 1? - Student 1
		// Line-19b. Has the Hope Scholarship Credit or AOTC been claimed for the student for any 4 tax years before the year entered on line 1? - Student 1
		chkF8862ScholarAmeoppClm1: "0" | "1"

		
		// Line-19b. Has the Hope Scholarship Credit or AOTC been claimed for the student for any 4 tax years before the year entered on line 1? - Student 2
		// Line-19b. Has the Hope Scholarship Credit or AOTC been claimed for the student for any 4 tax years before the year entered on line 1? - Student 2
		chkF8862ScholarAmeoppClm2: "1" | "0"

		
		// Line-19b. Has the Hope Scholarship Credit or AOTC been claimed for the student for any 4 tax years before the year entered on line 1? - Student 3
		// Line-19b. Has the Hope Scholarship Credit or AOTC been claimed for the student for any 4 tax years before the year entered on line 1? - Student 3
		chkF8862ScholarAmeoppClm3: "1" | "0"
		...
		cboF8862UsStateChld1: *"" | "AA" | "AE" | "AK" | "AL" | "AP" | "AR" | "AS" | "AZ" | "CA" | "CO" | "CT" | "DC" | "DE" | "FL" | "GA" | "GU" | "HI" | "IA" | "ID" | "IL" | "IN" | "KS" | "KY" | "LA" | "MA" | "MD" | "ME" | "MI" | "MN" | "MO" | "MP" | "MS" | "MT" | "NC" | "ND" | "NE" | "NH" | "NJ" | "NM" | "NV" | "NY" | "OH" | "OK" | "OR" | "PA" | "PR" | "RI" | "SC" | "SD" | "TN" | "TX" | "UT" | "VA" | "VI" | "VT" | "WA" | "WI" | "WV" | "WY"
		...
		cboF8862UsStateChld2: *"" | "AA" | "AE" | "AK" | "AL" | "AP" | "AR" | "AS" | "AZ" | "CA" | "CO" | "CT" | "DC" | "DE" | "FL" | "GA" | "GU" | "HI" | "IA" | "ID" | "IL" | "IN" | "KS" | "KY" | "LA" | "MA" | "MD" | "ME" | "MI" | "MN" | "MO" | "MP" | "MS" | "MT" | "NC" | "ND" | "NE" | "NH" | "NJ" | "NM" | "NV" | "NY" | "OH" | "OK" | "OR" | "PA" | "PR" | "RI" | "SC" | "SD" | "TN" | "TX" | "UT" | "VA" | "VI" | "VT" | "WA" | "WI" | "WV" | "WY"
		...
		cboF8862UsStateChld3: *"" | "AA" | "AE" | "AK" | "AL" | "AP" | "AR" | "AS" | "AZ" | "CA" | "CO" | "CT" | "DC" | "DE" | "FL" | "GA" | "GU" | "HI" | "IA" | "ID" | "IL" | "IN" | "KS" | "KY" | "LA" | "MA" | "MD" | "ME" | "MI" | "MN" | "MO" | "MP" | "MS" | "MT" | "NC" | "ND" | "NE" | "NH" | "NJ" | "NM" | "NV" | "NY" | "OH" | "OK" | "OR" | "PA" | "PR" | "RI" | "SC" | "SD" | "TN" | "TX" | "UT" | "VA" | "VI" | "VT" | "WA" | "WI" | "WV" | "WY"
		...
		cboF8862UsStateChld4: *"" | "AA" | "AE" | "AK" | "AL" | "AP" | "AR" | "AS" | "AZ" | "CA" | "CO" | "CT" | "DC" | "DE" | "FL" | "GA" | "GU" | "HI" | "IA" | "ID" | "IL" | "IN" | "KS" | "KY" | "LA" | "MA" | "MD" | "ME" | "MI" | "MN" | "MO" | "MP" | "MS" | "MT" | "NC" | "ND" | "NE" | "NH" | "NJ" | "NM" | "NV" | "NY" | "OH" | "OK" | "OR" | "PA" | "PR" | "RI" | "SC" | "SD" | "TN" | "TX" | "UT" | "VA" | "VI" | "VT" | "WA" | "WI" | "WV" | "WY"
		...
		// Line-22. Did any other person (except your spouse, if filing jointly, and your dependents claimed on your return) live with Child 1, Child 2, Child 3, or Child 4 for more than half the year?
		// Line-22. Did any other person (except your spouse, if filing jointly, and your dependents claimed on your return) live with Child 1, Child 2, Child 3, or Child 4 for more than half the year?
		chkF8862OthPersonU19Ind: "1" | "0"
