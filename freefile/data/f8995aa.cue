...
schemas: f8995aa: {
	fields: [{
		...
		title: "Line 1b. Taxpayer identification number. Column: C . (SSN - Enter only EIN or SSN, not both)"
		type:  "text"
	}, {
		maxlength: 10
		...
		maxlength: 10
		name:      "txtQbiSchaTaxableInc"
		tags: [
			"AMOUNT",
		]
		title: "Line 5. Taxable income before qualified business income deduction"
		type:  "text"
	}, {
		maxlength: 10
		name:      "txtQbiSchaThreshold"
		readonly:  true
		tags: [
			"AMOUNT",
		]
		...
		title: "Line 15. Taxpayer identification number. Column: C . (SSN - Enter only EIN or SSN, not both)"
		type:  "text"
	}, {
		maxlength: 10
		...
		maxlength: 10
		name:      "txtQbiSchaTaxableIncPrt2"
		tags: [
			"AMOUNT",
		]
		title: "Line 18. Taxable income before qualified business income deduction"
		type:  "text"
	}, {
		maxlength: 10
		name:      "txtQbiSchaThresholdPrt2"
		readonly:  true
		tags: [
			"AMOUNT",
		]
