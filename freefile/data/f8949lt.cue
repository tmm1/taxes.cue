...
schemas: f8949lt: {
	...
	fields: [{
		...
		options: [{
			value: "0"
			label: "(A) Long-term transactions reported on Form(s) 1099-B showing basis was reported to the IRS"
		}, {
			value: "1"
			label: "(B) Long-term transactions reported on Form(s) 1099-B showing basis wasn't reported to the IRS"
		}, {
			value: "2"
			label: "(C) Long-term transactions not reported to you on Form 1099-B"
		}]
	}, {
		type:      "text"
		name:      "txtDescrip1"
		...
		type:      "text"
		name:      "txtCode1"
		title:     "Line 1(f). Row 1. Code(s) from  instructions"
		maxlength: 7
		tags: [
			"UPPERCASE",
		]
		...
		type:      "text"
		name:      "txtCode2"
		title:     "Line 1(f). Row 2. Code(s) from  instructions"
		maxlength: 7
		tags: [
			"UPPERCASE",
		]
		...
		type:      "text"
		name:      "txtCode3"
		title:     "Line 1(f). Row 3. Code(s) from  instructions"
		maxlength: 7
		tags: [
			"UPPERCASE",
		]
		...
		title:     "Line 1(h). Row 3. Gain or (loss). Subtract column (e) from column (d) and combine the result with column (g) - This field will be automatically calculated for you"
		maxlength: 10
		readonly:  true
		tags: [
			"AMOUNT",
		...
		type:      "text"
		name:      "txtCode4"
		title:     "Line 1(f). Row 4. Code(s) from  instructions"
		maxlength: 7
		tags: [
			"UPPERCASE",
		]
		...
		type:      "text"
		name:      "txtCode5"
		title:     "Line 1(f). Row 5. Code(s) from  instructions"
		maxlength: 7
		tags: [
			"UPPERCASE",
		]
		...
		type:      "text"
		name:      "txtCode6"
		title:     "Line 1(f). Row 6. Code(s) from  instructions"
		maxlength: 7
		tags: [
			"UPPERCASE",
		]
		...
		type:      "text"
		name:      "txtCode7"
		title:     "Line 1(f). Row 7. Code(s) from  instructions"
		maxlength: 7
		tags: [
			"UPPERCASE",
		]
		...
		type:      "text"
		name:      "txtCode8"
		title:     "Line 1(f). Row 8. Code(s) from  instructions"
		maxlength: 7
		tags: [
			"UPPERCASE",
		]
		...
		type:      "text"
		name:      "txtCode9"
		title:     "Line 1(f). Row 9. Code(s) from  instructions"
		maxlength: 7
		tags: [
			"UPPERCASE",
		]
		...
		type:      "text"
		name:      "txtCode10"
		title:     "Line 1(f). Row 10. Code(s) from  instructions"
		maxlength: 7
		tags: [
			"UPPERCASE",
		]
		...
		type:      "text"
		name:      "txtCode11"
		title:     "Line 1(f). Row 11. Code(s) from  instructions"
		maxlength: 7
		tags: [
			"UPPERCASE",
		]
		...
		type:      "text"
		name:      "txtCode12"
		title:     "Line 1(f). Row 12. Code(s) from  instructions"
		maxlength: 7
		tags: [
			"UPPERCASE",
		]
		...
		type:      "text"
		name:      "txtCode13"
		title:     "Line 1(f). Row 13. Code(s) from  instructions"
		maxlength: 7
		tags: [
			"UPPERCASE",
		]
		...
		type:      "text"
		name:      "txtCode14"
		title:     "Line 1(f). Row 14. Code(s) from  instructions"
		maxlength: 7
		tags: [
			"UPPERCASE",
		]
