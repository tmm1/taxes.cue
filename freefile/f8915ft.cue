...
#f8915ft: {
	#input: {
		...
		chkF8915FCalenderYear: *"" |
			"2020" | // Calendar year in which disaster occurred
		...
		chkF8915FQualDistSep8606: *"" |
			"1" | // Line 17. Did you receive a qualified disaster distribution from a traditional, SEP, SIMPLE, or Roth IRA that is required to be reported on this year�s Form 8606? - Yes
		...
		chkF8915FP4DistSep8606: *"" |
			"1" | // Yes - Line 27. Did you receive a qualified distribution from a traditional, SEP, SIMPLE, or Roth IRA that is required to be reported on this year's Form 8606?
