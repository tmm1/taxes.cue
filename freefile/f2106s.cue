...
#f2106s: {
	#input: {
		...
		chkVehichePersonalUseInd: *"" |
			"1" | // Was your vehicle available for personal use during off-duty hours?
			"0" // Was your vehicle available for personal use during off-duty hours?

		
		chkAnotherVehicheInd: *"" |
			"1" | // Do you (or your spouse) have another vehicle available for personal use?
		...
		chkWrittenEvidenceInd: *"" |
			"1" | // If �Yes, � is the evidence written?
