...
#f8594: {
	#input: {
		...
		chkF8594WrittenDocInd: *"" |
			"1" | // Line 5. Yes - Did the purchaser and seller provide for an allocation of the sales price in the sales contract or in another written document signed by both parties?
		...
		chkF8594SepwriteDocInd: *"" |
			"1" | // Line 5. If Yes - aggregate FMV classes I, II, III, IV, V , VI, VII  the amounts agreed upon in your sales contract or in a seperate written document?
		...
		chkF8594NottoCompeteInd: *"" |
			"1" | // Line 6. Yes - In the purchase of the group of assets (or stock), did the purchaser also purchase a license or a covenant not to compete, or enter into a lease agreement, employment contract, management contract, or similar arrangement with the seller
