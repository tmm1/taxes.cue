...
#f8949lt: {
	#input: {
		...
		// Line 1(f). Row 1. Code(s) from  instructions
		txtCode1?: #UPPERCASE
		...
		// Line 1(f). Row 2. Code(s) from  instructions
		txtCode2?: #UPPERCASE
		...
		// Line 1(f). Row 3. Code(s) from  instructions
		txtCode3?: #UPPERCASE
		...
		// Line 1(f). Row 4. Code(s) from  instructions
		txtCode4?: #UPPERCASE
		...
		// Line 1(f). Row 5. Code(s) from  instructions
		txtCode5?: #UPPERCASE
		...
		// Line 1(f). Row 6. Code(s) from  instructions
		txtCode6?: #UPPERCASE
		...
		// Line 1(f). Row 7. Code(s) from  instructions
		txtCode7?: #UPPERCASE
		...
		// Line 1(f). Row 8. Code(s) from  instructions
		txtCode8?: #UPPERCASE
		...
		// Line 1(f). Row 9. Code(s) from  instructions
		txtCode9?: #UPPERCASE
		...
		// Line 1(f). Row 10. Code(s) from  instructions
		txtCode10?: #UPPERCASE
		...
		// Line 1(f). Row 11. Code(s) from  instructions
		txtCode11?: #UPPERCASE
		...
		// Line 1(f). Row 12. Code(s) from  instructions
		txtCode12?: #UPPERCASE
		...
		// Line 1(f). Row 13. Code(s) from  instructions
		txtCode13?: #UPPERCASE
		...
		// Line 1(f). Row 14. Code(s) from  instructions
		txtCode14?: #UPPERCASE
	...
	#output: {
		txtTaxpayerName2?: #UPPERCASE
		txtTaxpayerName2?: strings.MaxRunes(75)

		// SSN - This field will be automatically populated for you
		txtTaxPayerSSN2?: #UPPERCASE
		txtTaxPayerSSN2?: strings.MaxRunes(11)
		...
		// Line 1(h). Row 3. Gain or (loss). Subtract column (e) from column (d) and combine the result with column (g) - This field will be automatically calculated for you
